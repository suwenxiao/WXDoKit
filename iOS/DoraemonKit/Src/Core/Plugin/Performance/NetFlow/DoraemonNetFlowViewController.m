...
- (void)showNetFlowDetail {
    ...
    nav1.tabBarItem = [[UITabBarItem alloc] initWithTitle:DoraemonLocalizedString(@"网络监控摘要") image:[[WXDockit_Image(@"doraemon_netflow_summary_unselect") doraemon_scaledToSize:CGSizeMake(30,30)] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[WXDockit_Image(@"doraemon_netflow_summary_select") doraemon_scaledToSize:CGSizeMake(30,30)] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    ...
    nav2.tabBarItem = [[UITabBarItem alloc] initWithTitle:DoraemonLocalizedString(@"网络监控列表") image:[[WXDockit_Image(@"doraemon_netflow_list_unselect") doraemon_scaledToSize:CGSizeMake(30,30)] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[WXDockit_Image(@"doraemon_netflow_list_select") doraemon_scaledToSize:CGSizeMake(30,30)] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
